...
myIDirect3DDevice9::myIDirect3DDevice9(IDirect3DDevice9* pOriginal,D3DPRESENT_PARAMETERS* pPresentationParameters)
{
    m_pIDirect3DDevice9 = pOriginal; // store the pointer to original object
	pParams=pPresentationParameters;
}
...
{
	HRESULT res;
    res=(m_pIDirect3DDevice9->Reset(pPresentationParameters));
	return res;
}
